...
#ifndef PAGE_SPLIT_ORDER_BY_PAGE_SIZE_PROVIDER_H_
#define PAGE_SPLIT_ORDER_BY_PAGE_SIZE_PROVIDER_H_
...
class OrderByPageSizeProvider : public PageOrderProvider
{
public:
    OrderByPageSizeProvider(IntrusivePtr<Settings> const& settings);
...
#endif //PAGE_SPLIT_ORDER_BY_PAGE_SIZE_PROVIDER_H_
